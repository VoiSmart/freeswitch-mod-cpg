...
LDFLAGS=
SOURCES= arpator.c node.c cpg_utils.c profile.c mod_cpg.c
OBJECTS=$(SOURCES:.c=.o)
...
$(EXECUTABLE): $(OBJECTS) 
	$(CC) $(INCLUDE) $(CFLAGS) $(LDFLAGS) -lm -module -avoid-version -o mod_cpg.so -shared -Xlinker -x mod_cpg.o arpator.o node.o cpg_utils.o profile.o
